...
public class AgencyScreenTable {
	...
	public AgencyScreenTable(int agent_Id, String agent_Name,String Agent_type,int agentType_id, String agent_Phone, String agent_Address, String agent_District,int adress_id,
