...
public class DAO_Sales_Report implements Interface<Sales_Report>{
	...
	public int Add(Sales_Report t) {
		try {
			...
			String sql = "INSERT INTO SALES_REPORT(  SalesReport_Date)"
					+ "VALUES ( '" 
	...
	public ArrayList<Sales_Report> selectAll() {
		...
		try {
			...
			while (rs.next()) {
				...
				Sales_Report sale_report = new Sales_Report(SalesReport_Id,  SalesReport_Date);
				kq.add(sale_report);
			}
	...
	public ObservableList<Sales_Report> selectAll2() {
		ObservableList<Sales_Report> kq = FXCollections.observableArrayList();
		try {
			Connection con = JDBCUtil.getConnection();
	...
	public Sales_Report seclectById(Sales_Report t) {
		...
		try {
			...
			while (rs.next()) {
				...
				kq = new Sales_Report(SalesReport_Id, SalesReport_Date);
			}
	...
	public Sales_Report selectByCondition2(String condition) {
		Sales_Report kq = new Sales_Report();
