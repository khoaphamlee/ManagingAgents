...
public class DAO_Export implements Interface<Export>{
	...
	public int Add(Export t) {
		try {
			...
			String sql = "INSERT INTO EXPORT( Id_Agent, Id_User, Id_Receipt, Export_Date, Export_TotalMoney,PayAmount, Remaining)"
					+ "VALUES (" 
	...
	public ObservableList<Export> selectAll2() {
		ObservableList<Export> kq = FXCollections.observableArrayList();
		try {
			Connection con = JDBCUtil.getConnection();
	...
	public Export selectByCondition2(String condition) {
		Export kq = new Export();
