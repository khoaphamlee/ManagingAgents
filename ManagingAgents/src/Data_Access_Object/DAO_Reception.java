...
public class DAO_Reception implements Interface<Reception>{
	...
	public int Add(Reception t) {
		try {
			...
			String sql = "INSERT INTO RECEPTION( IdAgent, IdAgentType, ReceptionDate)"
					+ "VALUES ("   + t.getIdAgent() + " , " + t.getIdAgentType()
					+ " , '" + t.getReceptionDate() + "')";
	...
	public Reception selectByCondition2(String condition) {
		Reception kq = new Reception();
