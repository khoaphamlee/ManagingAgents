...
public class DAO_Debt_Agent_Report implements Interface<Debt_Agent_Report>{
	...
	public int Add(Debt_Agent_Report t) {
		try {
			...
			String sql = "INSERT INTO DEBT_AGENT_REPORT( DebtAgentReport_Date)"
					+ "VALUES ( ' "  
	...
	public ObservableList<Debt_Agent_Report> selectAll2() {
		ObservableList<Debt_Agent_Report> kq = FXCollections.observableArrayList();
		try {
			Connection con = JDBCUtil.getConnection();
