...
public class DAO_Debt_Agent_Report_Detail implements Interface<Debt_Agent_Report_Detail> {
	...
	public int Add(Debt_Agent_Report_Detail t) {
		try {
			...
			String sql = "INSERT INTO DEBT_AGENT_REPORT_DETAIL( IdDebtAgentReport, IdAgent, NoDau, PhatSinh, NoCuoi)"
					+ "VALUES (" 
	...
	public ObservableList<Debt_Agent_Report_Detail> selectByCondition2(String condition) {
		ObservableList<Debt_Agent_Report_Detail> kq = FXCollections.observableArrayList();
