...
public class DAO_Export_Detail implements Interface<Export_Detail>{
	...
	public int Add(Export_Detail t) {
		try {
			...
			String sql = "INSERT INTO EXPORT_DETAIL( IdExport,  ItemsId, ItemsQuantity, PriceExport, TotalMoney_Export)"
					+ "VALUES (" 
					+ t.getIdExport() + " , " 
	...
	public ArrayList<Export_Detail> selectAll() {
		...
		try {
			...
			while (rs.next()) {
				...
				Export_Detail export_detail = new Export_Detail(ExportDetail_Id, IdExport, Items, ItemsQuantity, PriceExport, TotalMoney_Export );
	...
	public Export_Detail seclectById(Export_Detail t) {
		...
		try {
			...
			while (rs.next()) {
				...
				kq = new Export_Detail(ExportDetail_Id, IdExport,  Items, ItemsQuantity, PriceExport, TotalMoney_Export );
			}
